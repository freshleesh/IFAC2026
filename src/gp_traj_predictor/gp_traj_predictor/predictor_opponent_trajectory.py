...
class GaussianProcessOppTraj(object):
    def __init__(self):
        ...
        # self.create_subscription(Odometry, '/opp/car_state/odom_frenet', self.opp_car_state_frenet_cb, 10) #testing with Rosbag
        self.create_subscription(OpponentTrajectory, '/opponent_trajectory', self.opp_traj_cb, 10) #testing with Rosbag
