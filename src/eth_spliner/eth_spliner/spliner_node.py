...
class ObstacleSpliner:
    ...
    def __init__(self):
        ...
        if not self.from_bag:
            self.create_subscription(Config, "/dynamic_eth_spline_tuner_node/parameter_updates", self.dyn_param_cb, 10)
    ...
    def dyn_param_cb(self, params: Config):
        ...
        """
        self.pre_apex_0 = -1 * self._get_param_or_default("dynamic_eth_spline_tuner_node/pre_apex_dist0", -4)
        self.pre_apex_1 = -1 * self._get_param_or_default("dynamic_eth_spline_tuner_node/pre_apex_dist1", -3)
        self.pre_apex_2 = -1 * self._get_param_or_default("dynamic_eth_spline_tuner_node/pre_apex_dist2", -1.5) + 0.1
        self.post_apex_0 = self._get_param_or_default("dynamic_eth_spline_tuner_node/post_apex_dist0", 2)
        self.post_apex_1 = self._get_param_or_default("dynamic_eth_spline_tuner_node/post_apex_dist1", 3)
        self.post_apex_2 = self._get_param_or_default("dynamic_eth_spline_tuner_node/post_apex_dist2", 4)

        self.evasion_dist = self._get_param_or_default("dynamic_eth_spline_tuner_node/evasion_dist", 0.65)
        self.obs_traj_tresh = self._get_param_or_default("dynamic_eth_spline_tuner_node/obs_traj_tresh", 0.3)
        self.spline_bound_mindist = self._get_param_or_default("dynamic_eth_spline_tuner_node/spline_bound_mindist", 0.2)

        self.kd_obs_pred = self._get_param_or_default("dynamic_eth_spline_tuner_node/kd_obs_pred")
        self.fixed_pred_time = self._get_param_or_default("dynamic_eth_spline_tuner_node/fixed_pred_time")
