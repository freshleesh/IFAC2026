...
class GlobalRepublisher:
    ...
    def __init__(self):
        ...
        self.create_subscription(MarkerArray, '/global_waypoints/vel_markers', self.glb_vel_markers_cb, 10)
        ### HJ : tuned velocity markers — built from latest global_waypoints velocity
        self.glb_vel_markers_tuned_pub = self.create_publisher(MarkerArray, 'global_waypoints/vel_markers_tuned', 10)
        ### HJ : end
