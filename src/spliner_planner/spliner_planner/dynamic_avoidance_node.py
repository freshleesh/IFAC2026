...
class DynamicAvoidanceNode(Node):
    ...
    def __init__(self):
        # Initialize node
        super().__init__('dynamic_avoidance_node', allow_undeclared_parameters=True, automatically_declare_parameters_from_overrides=True)
        ...
        self.create_subscription(Config, "/dynamic_avoidance_tuner_node/parameter_updates", self.dyn_param_cb, 10)
    ...
    def dyn_param_cb(self, params: object):
        self.evasion_dist = self._get_param_or_default("dynamic_avoidance_tuner_node/evasion_dist", 0.65)
        self.obs_traj_tresh = self._get_param_or_default("dynamic_avoidance_tuner_node/obs_traj_tresh", 1.5)
        self.spline_bound_mindist = self._get_param_or_default("dynamic_avoidance_tuner_node/spline_bound_mindist", 0.2)
        self.lookahead = self._get_param_or_default("dynamic_avoidance_tuner_node/lookahead_dist", 15)
        self.back_to_raceline_after = self._get_param_or_default("dynamic_avoidance_tuner_node/back_to_raceline_after", 5)
    ...
    def loop(self):
        ...
        # rospy.wait_for_message("/dynamic_avoidance_tuner_node/parameter_updates", Config)  # ROS2: ready flag polling 으로 변환 필요
