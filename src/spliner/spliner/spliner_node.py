...
class ObstacleSpliner:
    ...
    def dyn_param_cb(self, params: Config):
        ...
        """
        self.pre_apex_0 = -1 * self._get_param_or_default("dynamic_spline_tuner_node/pre_apex_dist0", -4)
        self.pre_apex_1 = -1 * self._get_param_or_default("dynamic_spline_tuner_node/pre_apex_dist1", -3)
        self.pre_apex_2 = -1 * self._get_param_or_default("dynamic_spline_tuner_node/pre_apex_dist2", -1.5) + 0.1
        self.post_apex_0 = self._get_param_or_default("dynamic_spline_tuner_node/post_apex_dist0", 2)
        self.post_apex_1 = self._get_param_or_default("dynamic_spline_tuner_node/post_apex_dist1", 3)
        self.post_apex_2 = self._get_param_or_default("dynamic_spline_tuner_node/post_apex_dist2", 4)
