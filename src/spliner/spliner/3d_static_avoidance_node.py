...
class StaticAvoidance3D:
    ...
    def __init__(self):
        ...
        self.safety_margin = self._get_param_or_default("dyn_planner_tuner/static_avoidance/safety_margin", 0.15)
    ...
    def _init_converter(self) -> FrenetConverter:
        ...
        self.get_logger().info(f"[{self.name}] FrenetConverter initialized")
        return converter
    ...
    def gb_cb(self, data: WpntArray):
        ...
        if self.track_validator is None:
            ...
            self.get_logger().info(f"[{self.name}] Track3DValidator initialized")
    ...
    def dyn_param_cb(self, params: object):
        ...
        self.kd_obs_pred = self._get_param_or_default("dyn_planner_tuner/static_avoidance/kd_obs_pred", 1.0)
        self.fixed_pred_time = self._get_param_or_default("dyn_planner_tuner/static_avoidance/fixed_pred_time", 0.15)
        self.sampling_dist = self._get_param_or_default("dyn_planner_tuner/static_avoidance/post_sampling_dist", 20.0)
        self.spline_scale = self._get_param_or_default("dyn_planner_tuner/static_avoidance/spline_scale", 0.8)
        self.post_min_dist = self._get_param_or_default("dyn_planner_tuner/static_avoidance/post_min_dist", 1.5)
        self.post_max_dist = self._get_param_or_default("dyn_planner_tuner/static_avoidance/post_max_dist", 5.0)
        self.safety_margin = self._get_param_or_default("dyn_planner_tuner/static_avoidance/safety_margin", 0.15)
