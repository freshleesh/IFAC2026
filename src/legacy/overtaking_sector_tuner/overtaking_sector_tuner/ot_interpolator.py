...
class OvertakingInterpolator:
    ...
    def __init__(self, debug_plot: bool = False) -> None:
        ...
        self.create_subscription(Config, "/dyn_sector_overtake/parameter_updates", self.dyn_param_cb, 10)
        self.create_subscription(Config, "/dyn_sector_speed/parameter_updates", self.dyn_speed_param_cb, 10)
