...
class LapAnalyser:
    def __init__(self):
        ...
        self.create_subscription(Empty, '/lap_analyser/start', self.start_log_cb, 10)
        self.create_subscription(Odometry, '/car_state/odom', self.odom_xy_cb, 10)  # New subscriber for x,y coordinate odom
